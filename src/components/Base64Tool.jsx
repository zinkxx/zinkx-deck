...
import { Copy, Trash, Check, Binary, Info } from 'lucide-react';

export default function Base64Tool({ showToast, t }) {
  ...
  return (
    <div className="tool-layout-split">
      <div className="panel">
        ...
        <div className="form-group">
          <textarea
            ...
            placeholder={mode === 'encode' ? 'Enter normal text...' : 'Enter Base64 encoded text...'}
            value={input}
        ...
        <div className="info-panel">
          ...
          <div className="info-panel-content">
            ...
            <div className="info-panel-desc">{t['base64-tool-info']}</div>
          </div>
        </div>
      </div>
      ...
      <div className="panel">
        <div className="panel-header">
          <div className="panel-title">
            <span>{t.output} ({mode === 'encode' ? 'Base64' : 'Decoded Text'})</span>
          </div>
          <div className="panel-actions">
            {output && (
